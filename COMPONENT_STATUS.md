...
- **Beta**: `accordion`, `autofill`, `combobox`, `date-picker`, `dialog`, `drawer`, `dropdown-menu`, `file-upload`, `input-otp`, `listbox`, `navigation-menu`, `pagination`, `popover`, `resizable`, `search`, `select`, `sidebar`, `table`, `tabs`, `theme`, `toast`, `toolbar`, `tooltip`.

...
- **Experimental**: `autofill`, `combobox`, `date-picker`, `dialog`, `drawer`, `dropdown-menu`, `file-upload`, `input-otp`, `listbox`, `navigation-menu`, `popover`, `resizable`, `select`, `sidebar`, `theme`, `toast`, `tooltip`.
...
| input           | stable       | CVA + Reactive Forms tests  | native input                   | focus-visible styles                    | yes  | unit + e2e docs          |
...
| textarea        | stable       | CVA + Reactive Forms tests  | native textarea                | focus-visible styles                    | yes  | unit                     |

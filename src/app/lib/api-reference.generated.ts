  ...
  directives: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { name: 'compareWith', type: '(a: unknown', default: 'Object.is' },
        ...
        { name: 'scrollToOption', type: '((index: number) =', default: 'undefined' },
        ...
        { name: 'trackByFn', type: '(index: number', default: '(_i, item) => item' },
      ],
  ...
  directives: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { name: 'max', type: 'Date' },
        { name: 'disabled', type: 'boolean', default: 'false', transform: 'booleanAttribute' },
        { name: 'dateDisabled', type: '(date: Date) =', default: '() => false' },
  ...
  directives: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { name: 'disabled', type: 'boolean', default: 'false', transform: 'booleanAttribute' },
        { name: 'compareWith', type: '(a: T', default: '(a, b) => a === b' },
        { name: 'isDisabled', type: 'unknown' },
      ],
  ...
  directives: [
    {
      ...
      inputs: [
        ...
        { name: 'valueLabel', type: '(value: number' },
      ],
      outputs: [],
    },
  ],
  ...
  directives: [
    {
      ...
      inputs: [
        ...
        { name: 'value', type: 'string | null', default: 'null' },
        { name: 'disabled', type: 'boolean', default: 'false', transform: 'booleanAttribute' },
        { name: 'compareWith', type: '(a: string | null', default: 'Object.is' },
      ],
      outputs: [{ name: 'valueChange', type: 'string | null' }],
    },
    {

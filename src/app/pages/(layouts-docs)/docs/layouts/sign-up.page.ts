...
// ==========================================
// 1. Social Sign Up Button
// ==========================================
@Component({
  selector: 'app-social-signup-button',
  imports: [VoltButton],
...
@Component({
  ...
  imports: [VoltCard, VoltInput, VoltLabel, VoltCheckbox, VoltButton, SocialSignUpButton],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
      ...
      <div class="space-y-4">
        <div class="grid grid-cols-2 gap-3">
          <div class="space-y-2">
            ...
            <volt-input placeholder="John" />
          </div>
          <div class="space-y-2">
            <volt-label>Last name</volt-label>
            <volt-input placeholder="Doe" />
          </div>
        </div>
        ...
        <div class="space-y-2">
          ...
          <volt-input type="password" placeholder="Create a password" />
        ...
        <div class="space-y-2">
          ...
          <volt-input type="password" placeholder="Repeat your password" />
        </div>

        <div class="flex items-start gap-2">
          <volt-checkbox id="terms" class="mt-0.5" />
          <volt-label htmlFor="terms" class="text-sm font-normal leading-relaxed">
            I agree to the
...
// ==========================================
@Component({
  selector: 'app-docs-signup',
  imports: [SignUpDemo],
  template: `
    <div class="max-w-5xl mx-auto py-8 px-4 w-full h-full">
      <h1 class="text-3xl font-bold tracking-tight mb-2">Sign Up</h1>
      <p class="text-lg text-muted-foreground mb-8">
        A registration layout with name, email, password fields, terms acceptance, and social
        sign-up options.
      </p>
      ...
      <div class="mt-16 space-y-4">
        ...
        <p class="text-muted-foreground text-sm">
          This layout features a centered registration card with full name, email, password and
          confirmation inputs, terms checkbox, social authentication buttons, and a link to the
          sign-in page. Copy the code and adapt it to your registration flow.
        </p>
      </div>
    </div>
  `,
})
export default class DocsSignUp {}

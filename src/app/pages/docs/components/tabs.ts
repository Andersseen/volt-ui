...
import { VoltButton, VoltInput, VoltLabel, VoltCard, VoltCardHeader, VoltCardTitle, VoltCardDescription, VoltCardContent, VoltCardFooter } from 'volt';

@Component({
  selector: 'app-tabs-demo',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [
    VoltTabs, VoltTabsList, VoltTabsTrigger, VoltTabsContent,
    VoltButton, VoltInput, VoltLabel, VoltCard, VoltCardHeader, VoltCardTitle, VoltCardDescription, VoltCardContent, VoltCardFooter
  ],
  template: `
    <div class="space-y-6">
      <div>
      ...
      <div class="border rounded-xl border-border/50 p-6 md:p-10 flex flex-col items-center justify-center bg-background/50 relative overflow-hidden min-h-[500px]">
            ...
            <volt-tabs-content value="account">
              <volt-card>
                <volt-card-header>
                  ...
                  <volt-card-description>Make changes to your account here. Click save when you're done.</volt-card-description>
                </volt-card-header>
            ...
            <volt-tabs-content value="password">
               <volt-card>
                <volt-card-header>
                  ...
                  <volt-card-description>Change your password here. After saving, you'll be logged out.</volt-card-description>
                </volt-card-header>
                <volt-card-content class="space-y-4">
                  <div class="space-y-2">

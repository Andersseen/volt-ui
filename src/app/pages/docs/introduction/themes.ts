    ...
    <div class="space-y-8">
      ...
      <div>
        ...
        <p class="text-lg text-muted-foreground mt-2">
          Customize the look and feel of your application with built-in themes, 
      ...
      <div class="space-y-4">
        ...
        <p class="text-muted-foreground">
          Volt UI comes with several pre-built color themes. Each theme provides 
          a unique palette for primary, secondary, accent, and semantic colors.
        </p>

        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <!-- Volt Theme -->
          <div class="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer group">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-lg bg-blue-500 flex items-center justify-center text-white font-bold">V</div>
              <div>
          ...
          <div class="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer group">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-lg bg-orange-500 flex items-center justify-center text-white font-bold">E</div>
              <div>
          ...
          <div class="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer group">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-lg bg-emerald-500 flex items-center justify-center text-white font-bold">S</div>
              <div>
          ...
          <div class="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer group">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-lg bg-violet-500 flex items-center justify-center text-white font-bold">D</div>
              <div>
          ...
          <div class="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer group">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-lg bg-cyan-500 flex items-center justify-center text-white font-bold">G</div>
              <div>
...
import {{ '{' }} provideVoltTheme {{ '}' }} from 'volt';

export const appConfig: ApplicationConfig = {{ '{' }}
  providers: [
    provideVoltTheme({{ '{' }} color: 'volt', style: 'soft', dark: false {{ '}' }})
  ]
{{ '}' }};
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <volt-card>
            ...
            <volt-card-content>
              <ul class="space-y-2 text-sm">
                <li><code class="px-1.5 py-0.5 bg-muted rounded">'soft'</code> - Rounded corners (default)</li>
                <li><code class="px-1.5 py-0.5 bg-muted rounded">'sharp'</code> - Square corners</li>
                <li><code class="px-1.5 py-0.5 bg-muted rounded">'brutal'</code> - Heavy borders</li>
                <li><code class="px-1.5 py-0.5 bg-muted rounded">'ghost'</code> - Minimal borders</li>
      ...
      <div class="space-y-4">
        ...
        <p class="text-muted-foreground">
          Volt UI supports dark mode out of the box. Enable it in your theme configuration 

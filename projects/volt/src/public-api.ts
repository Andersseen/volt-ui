...
export * from './lib/components/tabs/tabs-list.component';
export * from './lib/components/tabs/tabs-trigger.component';
export * from './lib/components/tabs/tabs-content.component';
